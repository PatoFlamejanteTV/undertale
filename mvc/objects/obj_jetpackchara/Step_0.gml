if(won == 0) {
    if(keyboard_check(37/* LEFT */) && x > 330) x-= 4;
    if(keyboard_check(39/* RIGHT */) && x < 620) x+= 4;
}
...
if(con == 17 && !instance_exists(779/* obj_dialoguer */)) {
    mett.x+= 8;
...
if(con == 34 && instance_exists(782/* OBJ_WRITER */) && mett.y < 240)
    mett.y+= 5;
