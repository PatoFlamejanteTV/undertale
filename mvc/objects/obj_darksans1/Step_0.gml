...
if(conversation == 10 && obj_mainchara.x >= obj_convenientlamp.x) {
    ...
    obj_mainchara.y+= 60;
    pap= instance_create(room_width, y - 12, 1031/* obj_papyrus_actor_mad */);
...
if(conversation == 12 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 16 && !instance_exists(782/* OBJ_WRITER */)) {
    conversation= 18;
    alarm[6]= 10;
...
if(conversation == 24 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 27 && !instance_exists(782/* OBJ_WRITER */)) {
    obj_papyrus_actor_mad.hspeed= 1;
...
if(conversation == 29 && !instance_exists(782/* OBJ_WRITER */)) {
    obj_mainchara.y-= 60;
...
if(conversation == 30 && instance_exists(1570/* obj_mainchara */) && obj_mainchara.x < rememberx - 30) {
    obj_mainchara.facing= 0;
    global.facing= 0;
    obj_mainchara.hspeed= 0;
    // obj_mainchara_actor
...
if(conversation == 50 && !instance_exists(782/* OBJ_WRITER */)) {
    hh= instance_create(0, 0, 92/* obj_musfadeout */);
    hh.fadespeed= 0.01;
    global.interact= 1;
    conversation= 51;
...
if(conversation == 53 && !instance_exists(782/* OBJ_WRITER */)) {
    sprite_index= 1363/* spr_sans_r */;
    pap= instance_create(room_width, y - 12, 1031/* obj_papyrus_actor_mad */);
    pap.sprite_index= 1336/* spr_papyrus_l_mad */;
    pap.direction= 180;
...
if(conversation == 55 && !instance_exists(782/* OBJ_WRITER */)) {
    obj_papyrus_actor_mad.image_speed= 0.5;
    obj_papyrus_actor_mad.sprite_index= 1328/* spr_papyrus_r */;
    obj_papyrus_actor_mad.hspeed= 4;
    hh= instance_create(0, 0, 92/* obj_musfadeout */);
...
if(conversation == 58 && !instance_exists(782/* OBJ_WRITER */)) {
    obj_mainchara.facing= 0;
    global.facing= 0;
    obj_mainchara.hspeed= 0;
    // obj_mainchara_actor
