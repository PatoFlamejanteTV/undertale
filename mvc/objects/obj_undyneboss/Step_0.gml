...
if(keyboard_multicheck_pressed(13/* ENTER */) && uncancel == 0 && alarm[5] > 5 && obj_lborder.x == global.idealborder[0] && alarm[6] < 0)
    alarm[5]= 2;
if(uncancel == 1) {
    alarm[5]= 100;
...
if(con == 67 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 68;
    global.typer= 44;
...
if(global.debug == 1 && keyboard_check_pressed(85/* U */))
