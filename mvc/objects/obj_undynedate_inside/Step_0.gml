...
if(con == 44 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 45;
    papyrus.hspeed= -2;
    global.typer= 37;
    global.facechoice= 5;
...
if(con == 52 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 51;
    global.interact= 0;
}
if(con == 60 && !instance_exists(782/* OBJ_WRITER */) && global.interact == 0) {
    global.interact= 1;
...
if(con == 84.1 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 85 && !instance_exists(782/* OBJ_WRITER */)) {
    obj_undynespear_anim1.part= 1;
    con= 86;
}
if(con == 88 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 90 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne.d= 1;
...
if(con == 95 && !instance_exists(782/* OBJ_WRITER */)) {
    // obj_musfadeout
...
if(con == 104 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne.npcdir= 0;
    undyne.fun= 1;
    undyne.image_index= 0;
    undyne.image_speed= 0.5;
...
if(con == 115) {
    undyne.image_speed= 0.5;
    if(undyne.image_index == 2) snd_play(47/* snd_grab */);
...
if(con == 125 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne.hspeed= -2;
    con= 126;
    alarm[4]= 5;
}
...
if(con == 141 && !instance_exists(782/* OBJ_WRITER */)) {
    global.facing= 2;
...
if(con == 151 && !instance_exists(782/* OBJ_WRITER */)) {
    global.flag[390]= 0;
    with(undyne) scr_npc_halt("d");
    with(undyne) fun= 1;
    undyne.image_index= 0;
...
if(con == 156 && !instance_exists(782/* OBJ_WRITER */)) {
    global.facing= 3;
    undyne.npcdir= 1;
    undyne.hspeed= -7;
...
if(con == 200 && !instance_exists(782/* OBJ_WRITER */)) {
    global.flag[20]= 0;
    global.msc= 0;
    global.faceemotion= 0;
...
if(con == 201 && !instance_exists(782/* OBJ_WRITER */)) {
    pp= instance_create(0, 0, 1057/* obj_potstir */);
    pp.pot= pot;
    con= 202;
}
if(con == 210 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 211;
    alarm[4]= 10;
}
if(con == 212) {
...
if(con == 213) {
    ...
    if(spear2.vspeed > 0 && spear2.y > pot.y - 17) {
        spear2.vspeed= -12;
        snd_play(14/* snd_spearrise */);
        if(!instance_exists(184/* obj_shaker */)) scr_shake(2, 2, 2);
        stab++;
        if(stab >= 2) {
...
if(con == 217 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 250 && !instance_exists(782/* OBJ_WRITER */)) {
    caster_free(-3);
    snd_play(44/* snd_laz */);
...
if(con == 252) {
    blk= instance_create(__view_get( e__VW.XView, 0 ) - 2, -2, 1363/* obj_npc_marker */);
...
if(con == 260 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne.sprite_index= undyne.utsprite;
    global.facing= 2;
    con= 261;
    alarm[4]= 120;
...
if(con == 263 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 264 && !instance_exists(782/* OBJ_WRITER */)) {
    caster_free(-3);
    global.msg[0]= "\\\\E2*\\\\M2 IT MEANS I CAN&  DESTROY YOU WITHOUT&  REGRET!/%%";
    instance_create(0, 0, 779/* obj_dialoguer */);
    con= 265;
}
if(con == 265 && !instance_exists(782/* OBJ_WRITER */)) {
    global.mercy= 1;
    global.battlegroup= 58;
    instance_create(0, 0, 142/* obj_battler */);
    con= 266;
}
if(con == 266 && !instance_exists(142/* obj_battler */)) {
    con= 267;
    room_persistent= 0;
    alarm[4]= 2;
}
...
if(con == 300 && !instance_exists(782/* OBJ_WRITER */)) {
    global.faceemotion= 0;
    instance_create(0, 0, 92/* obj_musfadeout */);
    con= 301;
    alarm[4]= 15;
...
if(con == 327 && !instance_exists(782/* OBJ_WRITER */)) {
    global.faceemotion= 0;
    with(undyne) scr_npc_halt("u");
    con= 328;
    alarm[4]= 180;
...
if(con == 332 && !instance_exists(782/* OBJ_WRITER */)) {
    global.faceemotion= 0;
    undyne.npcdir= 1;
    undyne.fun= 0;
    undyne.hspeed= -3;
...
if(con == 352.5 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne.npcdir= 1;
    undyne.fun= 0;
    undyne.hspeed= -3;
    undyne.vspeed= 0;
...
if(con == 363 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 364;
    alarm[4]= 90;
}
if(con == 365) {
...
if(con == 366 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 366.1;
    alarm[4]= 80;
}
if(con == 367.1) {
...
if(con == 367 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 368;
    alarm[4]= 60;
}
if(con == 369 && !instance_exists(782/* OBJ_WRITER */)) {
    global.flag[20]= 0;
    global.msg[0]= "\\\\E4* Y\\'know^1, I was a&  pretty hotheaded&  kid./";
    global.msg[1]= "* Once^1, to prove I was&  the strongest^1, I tried&  to fight ASGORE./";
    global.msg[2]= "\\\\E1* Emphasis on TRIED./";
...
if(con == 370 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 371;
    alarm[4]= 70;
}
if(con == 372) {
...
if(con == 373 && !instance_exists(782/* OBJ_WRITER */)) {
    instance_create(0, 0, 92/* obj_musfadeout */);
    con= 375;
    alarm[4]= 30;
}
...
if(con == 381 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne.y-= 15;
    undyne.npcdir= 1;
    undyne.fun= 0;
    undyne.hspeed= -3;
