...
if(con == 61 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 4 && connor == 0) {
    connor= 1;
    caster_pause(news);
}
if(con == 61 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
...
if(con == 66 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 4 && connor == 0) {
    connor= 1;
    caster_pause(news);
}
if(con == 66 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
...
if(con == 76 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 6 && connor == 0) {
    connor= 1;
    caster_pause(news);
}
if(con == 76 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
...
if(con == 86 && !instance_exists(782/* OBJ_WRITER */)) {
    caster_pause(news);
    snd_play(106/* snd_noise */);
...
if(con == 100 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 108 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
...
if(con == 110) con= 116;
if(con == 112 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
    present.sprite_index= present.bombsprite;
    con= 109;
    alarm[4]= 30;
...
if(con == 118 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
    basketball.sprite_index= basketball.bombsprite;
    con= 119;
    alarm[4]= 20;
}
if(con == 122 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(106/* snd_noise */);
    present.sprite_index= present.bombsprite;
    con= 119;
    alarm[4]= 20;
...
if(con == 125.1 && !instance_exists(782/* OBJ_WRITER */)) {
    wordfall= instance_create(__view_get( e__VW.XView, 0 ) + 20, __view_get( e__VW.YView, 0 ) + 20, 1230/* obj_wordfall */);
    global.typer= 5;
    global.msg[0]= "\\\\TS ^7  %";
    global.msg[1]= " %%";
    dg= instance_create(0, 0, 779/* obj_dialoguer */);
...
if(con == 126 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 129 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 130 && !instance_exists(782/* OBJ_WRITER */)) {
    caster_free(-3);
    global.mercy= 1;
    global.msc= 0;
    global.typer= 5;
...
if(con == 131 && !instance_exists(782/* OBJ_WRITER */)) {
    if(quickskip == 0) {
        // obj_mettanchor
    ...
    newgame.bombtype= 6;
    newticker= instance_create(__view_get( e__VW.XView, 0 ), __view_get( e__VW.YView, 0 ) + 200, 1231/* obj_mettnews_ticker */);
    newticker.on= 1;
    newticker.doom= 1;
    newticker.voff= 40;
...
if(con == 162) {
    ...
    mett= instance_create(__view_get( e__VW.XView, 0 ) + 340, __view_get( e__VW.YView, 0 ) + 70, 1223/* obj_mettanchor */);
    global.flag[20]= 8;
    mett.on= 2;
...
if(con == 165 && instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 170 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 47;
    mett.hspeed= 4;
    mett.on= 99;
    global.facechoice= 6;
...
if(con == 171 && !instance_exists(782/* OBJ_WRITER */)) {
