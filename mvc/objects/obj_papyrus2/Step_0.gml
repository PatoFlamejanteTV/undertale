...
if(conversation == 2 && !instance_exists(782/* OBJ_WRITER */)) {
    conversation= 3;
...
if(conversation == 6 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno > 7)
    papyrus.sprite_index= 1317/* spr_papyrus_orb */;
if(conversation == 6 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 8 && !instance_exists(782/* OBJ_WRITER */)) {
    global.interact= 1;
    conversation= 9;
    papyrus.fun= 1;
...
if(conversation == 13 && !instance_exists(782/* OBJ_WRITER */)) {
    papyrus.fun= 0;
...
if(conversation == 14 && !instance_exists(782/* OBJ_WRITER */)) {
    papyrus.sprite_index= papyrus.ltsprite;
    papyrus.image_speed= 0;
    global.faceemotion= 0;
    global.facechoice= 4;
...
if(conversation == 15 && !instance_exists(782/* OBJ_WRITER */)) {
    sans.sprite_index= sans.ltsprite;
    papyrus.npcdir= 1;
...
if(conversation == 16 && instance_exists(1032/* obj_papyrus_actor */)) {
    stepmake= 0;
    crunchybunchy+= 0.5;
...
if(conversation == 16 && instance_exists(1032/* obj_papyrus_actor */) && papyrus.path_position == 1) {
    papyrus.npcdir= 0;
    papyrus.sprite_index= 1317/* spr_papyrus_orb */;
...
if(conversation == 16.5 && !instance_exists(782/* OBJ_WRITER */)) {
    alarm[1]= 30;
...
if(conversation == 19 && instance_exists(1032/* obj_papyrus_actor */) && papyrus.path_position == 1) {
    papyrus.npcdir= 0;
    alarm[1]= 30;
    conversation= 20;
    papyrus.sprite_index= papyrus.ltsprite;
...
if(conversation == 23 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 51 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 51 && !instance_exists(782/* OBJ_WRITER */) && mc.x >= 158) {
    mc.x= 160;
    mc.hspeed= 0;
    mc.image_index= 0;
    mc.image_speed= 0;
...
if(conversation == 54 && !instance_exists(782/* OBJ_WRITER */)) {
    if(OBJ_WRITER.stringno == 4) {
        mc.hspeed= 3;
        mc.image_speed= 0.25;
    }
...
if(conversation == 54 && !instance_exists(782/* OBJ_WRITER */) && mc.x >= 218) {
    mc.x= 220;
    mc.hspeed= 0;
    mc.image_index= 0;
    mc.image_speed= 0;
...
if(conversation == 57 && !instance_exists(782/* OBJ_WRITER */)) {
    if(instance_exists(995/* obj_orbhead */)) {
        // obj_orbhead
        with(995) instance_destroy();
    }
