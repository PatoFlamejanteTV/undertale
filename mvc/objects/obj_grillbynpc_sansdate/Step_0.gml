...
if(con == 3.5 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 7.2 && !instance_exists(782/* OBJ_WRITER */)) {
    if(global.flag[53] != 1) {
...
if(con == 23 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 40 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno > 0) {
...
if(con == 41.6 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 1) {
    food1.image_index= 1;
    con= 42;
}
...
if(con == 43 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 2) {
...
if(con == 60 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 61;
    alarm[2]= 30;
}
if(con == 62) {
...
if(con == 70.2 && !instance_exists(782/* OBJ_WRITER */)) {
    image_speed= 0.25;
    vspeed= 2;
    sprite_index= dsprite;
    con= 70;
