...
sprite_index= gr;
if(global.debug == 1 && keyboard_check(32/* SPACE */)) {
    if(keyboard_check_pressed(39/* RIGHT */)) qq+= 0.2;
    if(keyboard_check_pressed(37/* LEFT */)) qq-= 0.2;
    if(keyboard_check_pressed(40/* DOWN */)) ww--;
    if(keyboard_check_pressed(38/* UP */)) ww++;
}
