...
if(con == 120 && !instance_exists(782/* OBJ_WRITER */)) {
    mett.hspeed= 1;
...
if(con == 123 && !instance_exists(779/* obj_dialoguer */)) {
    mett.arm= 12;
...
if(con == 240 && !instance_exists(782/* OBJ_WRITER */)) {
    skip= 1;
    con= 241;
}
if(con == 241 && !instance_exists(782/* OBJ_WRITER */)) {
    global.msc= 0;
