if(con == 1) {
    mkid= instance_create(__view_get( e__VW.XView, 0 ) - 40, obj_mainchara.y, 1115/* obj_mkid_actor */);
    mkid.image_speed= 0;
...
if(con == 1.3 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 2;
    alarm[4]= 50;
}
...
if(con == 28 && !instance_exists(782/* OBJ_WRITER */)) {
    undyne= instance_create(__view_get( e__VW.XView, 0 ) - 40, 82, 1117/* obj_undynea_actor */);
...
if(con == 34) {
    ...
    con= 35;
    global.flag[17]= 1;
    doorb= instance_create(__view_get( e__VW.XView, 0 ) - 20, obj_mainchara.y + 10, 806/* obj_doorB */);
    doora= instance_create(__view_get( e__VW.XView, 0 ) + __view_get( e__VW.WView, 0 ) + 20, obj_mainchara.y + 10, 805/* obj_doorA */);
    undynetimer= 0;
    finaltimer= 0;
    mkidtalk= 0;
    charge= 0;
...
if(con == 35) {
    ...
    if(mkidtalk == 1 && !instance_exists(782/* OBJ_WRITER */)) {
        global.interact= 0;
        mkidtalk= 2;
    }
...
if(con == 72 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 73;
...
if(con == 106 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 107;
    alarm[4]= 20;
}
if(con == 108) {
...
if(con == 115 && !instance_exists(782/* OBJ_WRITER */)) {
    mkid.hspeed= -4;
    mkid.image_speed= 0.5;
    mkid.sprite_index= mkid.lsprite;
    con= 116;
...
if(con == 150 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 6)
    global.facing= 2;
if(con == 150 && !instance_exists(782/* OBJ_WRITER */)) {
    global.facing= 3;
...
if(con == 157 && instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 162 && !instance_exists(782/* OBJ_WRITER */)) {
    mkid.hspeed= -4;
    mkid.image_speed= 0.5;
    mkid.sprite_index= mkid.lsprite;
    con= 163;
