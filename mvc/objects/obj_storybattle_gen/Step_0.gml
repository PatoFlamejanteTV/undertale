if(skipper == 1 && instance_exists(782/* OBJ_WRITER */)) {
    if(keyboard_multicheck_pressed(1/* ANYKEY */) && alarm[4] > 10)
        alarm[4]= 10;
    scr_textskip();
}
...
if(global.turntimer < 14 && !instance_exists(149/* obj_unfader */)) {
...
if(con == 7 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 12 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 19 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 27 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 34 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 42 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
    global.msg[0]= "The next day./%%";
    blcon2= instance_create(400, 20, 186/* obj_blconsm */);
    blcon2.sprite_index= 24/* spr_blconabove */;
    blconwd2= instance_create(430, 30, 782/* OBJ_WRITER */);
...
if(con == 46 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 52 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 64 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 74 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 84 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 94 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 102 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 107 && instance_exists(782/* OBJ_WRITER */) && blconwd1.halt != 0) {
...
if(con == 114 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 124 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 134 && instance_exists(782/* OBJ_WRITER */) && blconwd2.halt != 0) {
...
if(con == 301 && !instance_exists(782/* OBJ_WRITER */)) {
    off= 1;
    con= 302;
}
if(con == 305) {
...
if(con == 381 && instance_exists(782/* OBJ_WRITER */) && con == 381 && OBJ_WRITER.stringno == 1)
...
if(con == 384 && instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 5)
    global.faceemotion= 10;
if(con == 384 && !instance_exists(782/* OBJ_WRITER */)) off= 1;
if(con == 390) {
    shake= 0.75;
    global.typer= 99;
    global.msc= 0;
