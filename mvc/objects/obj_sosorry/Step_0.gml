...
if(n_con == 1 && !instance_exists(782/* OBJ_WRITER */)) {
    global.border= 0;
    global.typer= 1;
    obj_heart.x= -200;
    obj_heart.y= 900;
...
if(d_con == 1 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(d_con == 6 && !instance_exists(782/* OBJ_WRITER */)) {
    visible= 0;
...
if(p_con == 2) {
    ...
    global.monsterinstance[1]= instance_create(26, 88, 454/* obj_doodlebug */);
    global.monsterinstance[2]= instance_create(526, 88, 454/* obj_doodlebug */);
    with(global.monsterinstance[2]) specialmessage= 1;
    p_con= 3;
    alarm[4]= 50;
}
if(p_con == 1 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(p_con == 5 && !instance_exists(782/* OBJ_WRITER */)) {
    global.flag[20]= 0;
    p_con= 0;
    global.mnfight= 2;
}
