if(instance_exists(1570/* obj_mainchara */) && obj_mainchara.x > x && con == 0) {
    con= 2;
    ...
    undyne= instance_create(__view_get( e__VW.XView, 0 ) - 420, 100, 1117/* obj_undynea_actor */);
    undyne.rsprite= 1456;
    undyne.direction= 0;
    undyne.sprite_index= undyne.rsprite;
}
if(instance_exists(1570/* obj_mainchara */) && con == 2 && obj_mainchara.x < x - 320 && global.interact == 0) {
    con= 1.5;
    alarm[4]= 30;
    global.interact= 1;
