if(con == 0 && instance_exists(1570/* obj_mainchara */) && obj_mainchara.x > 120) {
    with(mkid) {
        follow= 99;
...
if(con == 6 && !instance_exists(782/* OBJ_WRITER */) && global.interact == 0) {
    unbuffer++;
    // obj_mainchara
    with(1570) uncan= 1;
} else  {
...
if(con == 6 && !instance_exists(782/* OBJ_WRITER */) && global.interact == 0 && unbuffer >= 4) {
    // obj_mainchara
    with(1570) uncan= 1;
    // obj_dialoguer
