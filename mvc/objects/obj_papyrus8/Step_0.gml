...
if(global.flag[68] == 1 && conversation == 17 && !instance_exists(782/* OBJ_WRITER */)) {
    room_persistent= 0;
    global.mercy= 0;
    global.interact= 1;
...
if(conversation == 22.6 && !instance_exists(782/* OBJ_WRITER */)) {
    global.msc= 0;
...
if(conversation == 22.8 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 90 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(conversation == 95 && !instance_exists(782/* OBJ_WRITER */)) {
    conversation= 96;
    alarm[4]= 15;
    chara.hspeed= 2;
    chara.image_speed= 0.25;
...
if(conversation == 100 && !instance_exists(782/* OBJ_WRITER */)) {
    conversation= 101;
    alarm[4]= 30;
    chara.hspeed= 2;
    chara.image_speed= 0.25;
