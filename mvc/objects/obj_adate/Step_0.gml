...
if(cn == 0 && !instance_exists(782/* OBJ_WRITER */)) {
    // OBJ_WRITER
...
if(cn == 2 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 3;
    alarm[4]= 60;
}
if(cn == 4) {
...
if(cn == 6 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 6.1;
    alarm[4]= 55;
...
if(cn == 8 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 1;
    global.msc= 0;
...
if(cn == 9 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(cn == 11 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 74;
    global.faceemotion= 0;
    global.flag[20]= 0;
...
if(cn == 12 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 13;
    alarm[4]= 90;
}
if(cn == 14) {
...
if(cn == 20 && !instance_exists(782/* OBJ_WRITER */)) {
    with(mfo) instance_destroy();
    global.typer= 74;
    global.faceemotion= 3;
    global.flag[20]= 0;
...
if(cn == 21 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 1 && OBJ_WRITER.halt != 0) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
    global.msg[0]= "                              &   Yes             No       &                            ";
...
if(cn == 25 && !instance_exists(782/* OBJ_WRITER */)) {
    global.faceemotion= 3;
    alarm[4]= 100;
    cn= 26;
}
...
if(cn == 28 && !instance_exists(782/* OBJ_WRITER */)) {
    al.hspeed= -8;
...
if(cn == 30) {
    ...
    global.faceemotion= 0;
    global.flag[20]= 0;
    al= instance_create(room_width + 160, 180, 176/* obj_adate_body */);
...
if(cn == 33 && !instance_exists(782/* OBJ_WRITER */)) {
    mfo= instance_create(0, 0, 92/* obj_musfadeout */);
    mfo.fadespeed= 0.04;
    global.faceemotion= 3;
    cn= 34;
...
if(cn == 36 && !instance_exists(782/* OBJ_WRITER */)) {
    al.x-= 10;
...
if(cn == 42 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 6 && OBJ_WRITER.halt != 0) {
    al.shake= 2;
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 46 && !instance_exists(782/* OBJ_WRITER */)) {
    mfo= instance_create(0, 0, 92/* obj_musfadeout */);
    und.hspeed= 20;
    cn= 47;
    alarm[4]= 40;
...
if(cn == 50 && !instance_exists(782/* OBJ_WRITER */)) {
    al.depth= 0;
    al.x+= 10;
    if(al.y < nowy) al.y+= 4;
    if(al.x > xx) {
...
if(cn == 54 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 25 && OBJ_WRITER.halt != 0) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 58 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 59;
    alarm[4]= 10;
}
if(cn == 60) {
...
if(cn == 64 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 3 && OBJ_WRITER.halt != 0) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 71 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 2 && OBJ_WRITER.halt != 0) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 74.1 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 74.2;
    alarm[4]= 20;
}
if(cn == 75.2) cn= 75;
if(cn == 75 && !instance_exists(782/* OBJ_WRITER */)) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 79 && !instance_exists(782/* OBJ_WRITER */)) {
    pitch= 0.75;
    al.shake= 2;
    global.typer= 75;
    if(choice == 0) {
...
if(cn == 91 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 6 && OBJ_WRITER.halt != 0) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 94.1 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 94.2;
    alarm[4]= 20;
}
if(cn == 95.2) cn= 95;
if(cn == 95 && !instance_exists(782/* OBJ_WRITER */)) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 99 && !instance_exists(782/* OBJ_WRITER */)) {
    pitch= 0.75;
    al.shake= 2;
    global.typer= 75;
    if(choice == 0) {
...
if(cn == 110 && instance_exists(782/* OBJ_WRITER */)) {
...
if(cn == 113.1 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 113.2;
    alarm[4]= 5;
    al.hspeed= 10;
}
if(cn == 114.2) cn= 114;
if(cn == 114 && !instance_exists(782/* OBJ_WRITER */)) {
    xx= al.x;
    yy= al.y;
    al.hspeed= 0;
    global.typer= 74;
...
if(cn == 115 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 39;
    xxx= und.x;
    yyy= und.y;
...
if(cn == 116 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 74;
    global.faceemotion= 1;
    global.flag[20]= 0;
...
if(cn == 117 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 39;
    xxx= und.x;
    yyy= und.y;
    global.msg[0]= "\\\\F3WHAT???/%%";
...
if(cn == 118 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 74;
    global.faceemotion= 8;
    global.flag[20]= 0;
...
if(cn == 119 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(cn == 120 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 39;
    xxx= und.x;
    yyy= und.y;
...
if(cn == 121 && !instance_exists(782/* OBJ_WRITER */)) {
    trashcan.depth= 90;
    al.depth= -1;
    und.depth= 0;
    global.typer= 74;
...
if(cn == 122 && !instance_exists(782/* OBJ_WRITER */)) {
    al.hspeed= -10;
    cn= 121.1;
    alarm[4]= 15;
}
...
if(cn == 122.3 && !instance_exists(782/* OBJ_WRITER */)) {
    al.hspeed= -10;
    cn= 121.4;
    alarm[4]= 5;
}
...
if(cn == 122.5 && !instance_exists(782/* OBJ_WRITER */)) {
    al.hspeed= -10;
    cn= 121.6;
    alarm[4]= 5;
}
...
if(cn == 122.8 && !instance_exists(782/* OBJ_WRITER */)) {
    al.hspeed= -9;
    cn= 121.9;
    alarm[4]= 5;
}
...
if(cn == 125 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 39;
    xxx= und.x;
    yyy= und.y;
    global.msg[0]= "Alphys./%%";
...
if(cn == 127 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 74;
    global.faceemotion= 5;
    global.flag[20]= 0;
...
if(cn == 130 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 39;
    xxx= und.x;
    yyy= und.y;
    und.visible= 0;
...
if(cn == 131 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 74;
    global.faceemotion= 5;
    global.flag[20]= 0;
...
if(cn == 132 && !instance_exists(782/* OBJ_WRITER */)) {
    thrower.con= 1;
    global.typer= 39;
    xxx= und.x;
    yyy= und.y;
...
if(cn == 133 && !instance_exists(782/* OBJ_WRITER */)) {
    cn= 134;
    alarm[4]= 30;
}
if(cn == 135) {
...
if(cn == 140 && !instance_exists(782/* OBJ_WRITER */)) {
    trashcan.shake= 3;
    cn= 141;
    alarm[4]= 30;
}
...
if(cn == 145 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(cn == 146 && !instance_exists(782/* OBJ_WRITER */)) {
    global.faceemotion= 0;
    caster_stop(global.currentsong);
...
if(cn == 149 && !instance_exists(782/* OBJ_WRITER */)) {
    pap.con= 2;
    cn= 150;
    alarm[4]= 60;
}
...
if(cn == 153 && !instance_exists(782/* OBJ_WRITER */)) {
    global.faceemotion= 2;
...
if(cn == 155 && !instance_exists(782/* OBJ_WRITER */)) {
    xx= trashcan.x;
    yy= trashcan.y - trashcan.sprite_height * 2 + 20;
    global.typer= 74;
    global.faceemotion= 0;
...
if(cn == 156 && !instance_exists(782/* OBJ_WRITER */)) {
    // obj_musfadeout
    with(92) instance_destroy();
    pap.hspeed= 10;
    trashcan.hspeed= 10;
...
if(cn == 158.1 && !instance_exists(782/* OBJ_WRITER */)) {
    alarm[4]= 15;
    cn= 158.2;
}
if(cn == 159.2) cn= 159;
if(cn == 159 && !instance_exists(782/* OBJ_WRITER */)) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
...
if(cn == 163 && !instance_exists(782/* OBJ_WRITER */)) {
    mfo= instance_create(0, 0, 92/* obj_musfadeout */);
    cn= 164;
    alarm[4]= 20;
}
if(cn == 165 && !instance_exists(782/* OBJ_WRITER */)) {
    if(choice == 0) {
        global.msg[0]= "\\\\F6.../";
...
if(cn == 166 && !instance_exists(782/* OBJ_WRITER */)) {
    und.hspeed= 20;
    cn= 167;
    alarm[4]= 30;
}
...
if(cn == 999 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(cn == 100 && !instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 6 && OBJ_WRITER.halt != 0) {
    choice= 0;
    choicer= 1;
    global.typer= 1;
    global.msg[0]= "                              &   Yes             No       &                            ";
