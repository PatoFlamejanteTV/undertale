...
if(talked == 2 && !instance_exists(782/* OBJ_WRITER */))
    event_user(1);
...
if(con == 53 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 54;
    alarm[4]= 45;
}
if(con == 54) {
...
if(con == 55 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 54;
    with(mypart1) dsf= 0;
...
if(con == 91 && instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 94 && !instance_exists(782/* OBJ_WRITER */)) {
    global.typer= 51;
    global.msc= 0;
...
if(con == 96 && !instance_exists(782/* OBJ_WRITER */)) {
    // obj_blconsm
...
if(con == 98 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(104/* snd_phone */);
...
if(con == 99 && !instance_exists(782/* OBJ_WRITER */)) {
    snd_play(104/* snd_phone */);
...
if(con == 103 && instance_exists(782/* OBJ_WRITER */)) {
...
if(global.myfight == 4 && global.mercyuse == 0) script_execute(163/* scr_mercystandard */);
