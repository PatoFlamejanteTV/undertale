...
var k_up, k_down, k_left, k_right, k_up_r, k_down_r, k_left_r, k_right_r;
k_up= keyboard_check(38/* UP */);
k_down= keyboard_check(40/* DOWN */);
k_left= keyboard_check(37/* LEFT */);
k_right= keyboard_check(39/* RIGHT */);
k_up_r= keyboard_check_released(38/* UP */);
k_down_r= keyboard_check_released(40/* DOWN */);
k_left_r= keyboard_check_released(37/* LEFT */);
k_right_r= keyboard_check_released(39/* RIGHT */);
up= 0;
down= 0;
left= 0;
right= 0;
if(k_up) try_up= 1;
if(k_up_r) try_up= 0;
if(k_down) try_down= 1;
if(k_down_r) try_down= 0;
if(k_right) try_right= 1;
if(k_right_r) try_right= 0;
if(k_left) try_left= 1;
if(k_left_r) try_left= 0;
if(global.osflavor == 1) {
    ...
    if(try_up) up= k_up;
    if(try_down) down= k_down;
    if(try_left) left= k_left;
    if(try_right) right= k_right;
}
if(k_up_r) up= 0;
if(k_down_r) down= 0;
if(k_left_r) left= 0;
if(k_right_r) right= 0;
