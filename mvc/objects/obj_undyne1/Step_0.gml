...
if(con == 80 && !instance_exists(782/* OBJ_WRITER */) && minicon == 0 && (OBJ_WRITER.stringno == 13 || OBJ_WRITER.stringno == 14)) {
...
if(con == 80 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 82 && !instance_exists(782/* OBJ_WRITER */)) {
    global.msg[0]= "\\\\M0.../";
