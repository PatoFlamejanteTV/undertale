...
if(instance_exists(861/* obj_toroverworld3 */) && conversation == 4 && toriel.path_position == 1) {
...
if(instance_exists(861/* obj_toroverworld3 */) && conversation == 5 && !instance_exists(782/* OBJ_WRITER */)) {
    conversation= 6;
    // obj_toroverworld3
