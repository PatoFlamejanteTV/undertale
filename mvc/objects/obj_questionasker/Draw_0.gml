...
if(phase > 0 && con == 0) sprite_index= 344/* spr_alphyshelper_lookup */;
...
if(phase == 2 && quiztimer > 320) sprite_index= 345/* spr_alphyshelper_confused */;
if(phase > 2 && q < 10) {
...
if(q == 8 && quiztimer < 300) {
    ...
    if(!instance_exists(300/* obj_mettatonnn_writer */) && phase == 2)
...
if(con == 1) {
    go= 0;
    if(!instance_exists(782/* OBJ_WRITER */)) go= 1;
    if(!instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 5)
        go= 1;
    if(go == 1) {
        image_speed-= 0.004;
        if(image_speed <= 0) {
...
if(con == 4) {
    if(instance_exists(782/* OBJ_WRITER */) && OBJ_WRITER.stringno == 1)
...
if(con == 22 && !instance_exists(782/* OBJ_WRITER */)) {
    sprite_index= 343/* spr_alphyshelper */;
...
if(con == 34 && !instance_exists(782/* OBJ_WRITER */)) {
