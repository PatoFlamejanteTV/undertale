...
if(con == 18) {
    ...
    global.typer= 9;
    global.msg[10]= "%%%";
    mywriter= instance_create(__view_get( e__VW.XView, 0 ) + 30, __view_get( e__VW.YView, 0 ) + 100, 1598/* obj_flowey_writer */);
    con= 19;
}
...
if(con == 35 && !instance_exists(1598/* obj_flowey_writer */)) {
...
if(con == 40 && !instance_exists(1598/* obj_flowey_writer */)) {
...
if(con == 41 && !instance_exists(1598/* obj_flowey_writer */)) {
    // obj_floweyfacer
