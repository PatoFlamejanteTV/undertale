if(con == 107) {
    ...
    if(con >= 4 && instance_exists(755/* obj_btparent */) && obj_btparent.image_alpha > 0)
        obj_btparent.image_alpha-= 0.02;
    if(con >= 12 && instance_exists(757/* obj_borderparent */)) {
    ...
    if(asgore == 1) {
        if(remove == 0) {
            ...
            draw_sprite_ext(629/* spr_asgore_lastface */, global.faceemotion, asgorex + 136, asgorey - 8, 2, 2, 0, 16777215, 1);
        }
        if(remove == 1) {
            ry+= 2;
            if(ry < 49)
    ...
    if(con == 10 && !instance_exists(782/* OBJ_WRITER */)) {
        ...
        obj_heart.x= -999;
        fkhrt= instance_create(320, global.idealborder[2] + 60, 748/* obj_fakeheart */);
        con= 11;
    }
    if(con == 15) {
        caster_free(-3);
    ...
    if(con == 19 && !instance_exists(782/* OBJ_WRITER */)) {
        con= 18.5;
        alarm[4]= 50;
    }
    if(con == 19.5) con= 20;
    ...
    if(flowey == 1) {
        ...
        if(murder == 1 && fimg >= 8)
            draw_sprite_ext(624/* spr_flowey_as */, global.faceemotion, 285, 150, 2, 2, 0, 16777215, 1);
        if(fimg < 8) fimg+= 0.5;
    }
    if(flowey == 3) {
    ...
    if(con == 97 && !instance_exists(782/* OBJ_WRITER */)) {
    ...
    if(con == 99.5 && !instance_exists(782/* OBJ_WRITER */)) {
    ...
    if(con == 102 && !instance_exists(782/* OBJ_WRITER */)) {
        caster_play(cym, 1, 1);
    ...
    if(con == 132 && !instance_exists(782/* OBJ_WRITER */)) {
        ini_open("undertale.ini");
    ...
    if(con == 133 && !instance_exists(782/* OBJ_WRITER */)) {
    ...
    if(con == 138 && !instance_exists(782/* OBJ_WRITER */)) {
        con= 139;
        alarm[4]= 30;
    }
    if(con == 140) con= 58;
    ...
    if(con == 152 && !instance_exists(782/* OBJ_WRITER */)) {
        global.msc= 0;
        global.typer= 103;
    ...
    if(con == 153 && !instance_exists(782/* OBJ_WRITER */)) {
