...
if(con == 25 && !instance_exists(782/* OBJ_WRITER */)) {
    labvolume-= 0.03;
...
if(con == 49 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 50;
    alarm[4]= 20;
}
if(con == 51) {
...
if(con == 53) {
    ...
    shadow= instance_create(__view_get( e__VW.XView, 0 ), 0, 1363/* obj_npc_marker */);
...
if(con == 56 && !instance_exists(782/* OBJ_WRITER */)) {
    caster_play(cheer, 1, 1);
    caster_loop(gameshow, 1, 1);
    shadow.image_alpha= 0.95;
    dball= instance_create(__view_get( e__VW.XView, 0 ) + 60, -30, 1284/* obj_discoball */);
    obj_discoball.depth= 13;
    con= 57;
}
if(con == 57) {
    repeat(2) 
        instance_create(__view_get( e__VW.XView, 0 ) + random(320), __view_get( e__VW.YView, 0 ) - 10, 109/* obj_confetti */);
...
if(con == 60) {
    conf= instance_create(obj_mainchara.x + random(20), __view_get( e__VW.YView, 0 ) - 10, 109/* obj_confetti */);
...
if(con == 63 && !instance_exists(782/* OBJ_WRITER */)) {
    mett.image_speed= 0;
    snd_play(10/* snd_drumroll */);
    con= 64;
    alarm[4]= 60;
...
if(con == 69.1 && !instance_exists(142/* obj_battler */)) {
    global.mercy= 0;
    global.interact= 1;
