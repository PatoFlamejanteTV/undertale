...
if(con == 5.1 && !instance_exists(782/* OBJ_WRITER */)) {
    con= 4.2;
    alarm[4]= 30;
}
if(con == 5.2 && !instance_exists(782/* OBJ_WRITER */)) {
...
if(con == 30 && !instance_exists(782/* OBJ_WRITER */)) con= 7;
if(con == 100) {
...
if(con == 101 && !instance_exists(782/* OBJ_WRITER */)) {
    mc.image_index= 1;
    mc.hspeed= 0.5;
    con= 102;
    alarm[4]= 10;
...
if(con == 111 && !instance_exists(782/* OBJ_WRITER */)) {
